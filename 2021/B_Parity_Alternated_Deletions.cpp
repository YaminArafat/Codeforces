...
int main()
{
    ...
    int n,odd=0,even=0;
    cin>>n;
    int arr[n+5],sumodd[n+5],sumeven[n+5];
    for0(i,n,1)
    {
        cin>>arr[i];
    }
    ...
    for0(i,n,1)
    {
        ...
        {
            odd++;
            sumodd[odd]=sumodd[odd-1]+arr[i];
        }
        else
        {
            even++;
            sumeven[even]=sumeven[even-1]+arr[i];
        }
    }
    //see2(odd,even);
    if(abs(odd-even)<=1)
    ...
    {
        cout<<sumeven[even-odd-1]<<endl;
    }
    else if(even<odd)
    {
        cout<<sumodd[odd-even-1]<<endl;
    }
    else if(even==odd)
    {
        cout<<"0"<<endl;
